...
export const createPromptTemplateTool = {
  ...
  - The tool output -- both the ${templateVar} and ${contextSchemaVar} -- will also be used as input to the \`${PromptWorkbenchToolName.recommend_prompt_template_tests}\` tool to generate a list of recommended tests that can be used to test the prompt template.
  `,
